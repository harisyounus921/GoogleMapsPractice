     ...
     /* globalBackgroundColor: Color(0xFF1E4090),
      ...
      globalFooter: SizedBox(
        ...
        child: ElevatedButton(
          ...
          onPressed: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => CustomMarkerScreen()),),
        ),
      ),
      pages: [
        PageViewModel(
      ...
      onDone: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => CustomMarkerScreen()),),
      onSkip: () =>Navigator.of(context).push(MaterialPageRoute(builder: (_) => CustomMarkerScreen()),),
      showSkipButton: true,
      skipOrBackFlex: 0,
      nextFlex: 0,
      //showBackButton: true,
